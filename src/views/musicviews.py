...
class ActionsView(View):
    ...
    async def help_callback(self, interaction: discord.Interaction):
        ...
        embed.add_field(name="🔄 Dynamic Playlists", value="`/dynamic-playlist create <name> <url>` - Creates a dynamic playlist linked to a source URL\n`/dynamic-playlist list` - Lists your dynamic playlists\n`/dynamic-playlist play <name>` - Plays a dynamic playlist (fetches tracks live from source)\n`/dynamic-playlist delete <name>` - Deletes a dynamic playlist", inline=False)
